...
enum SettingsTab: String, CaseIterable, Identifiable {
    case style, voice, display, screens, connect, ai, scripts
    ...
    var icon: String {
        ...
        case .voice:   return "mic.badge.waveform"
        case .display: return "text.word.spacing"
        case .screens: return "tv"
        case .connect: return "wifi"
        case .ai:      return "brain.head.profile"
        case .scripts: return "doc.text.magnifyingglass"
        }
    }
}
...
struct SettingsView: View {
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        VStack(alignment: .leading, spacing: 6) {
                            ...
                            HStack(spacing: 8) {
                                ...
                                Button("Restart") {
                                    FlowCueService.shared.browserServer.stop()
                                    FlowCueService.shared.browserServer.start()
    ...
    private var aiTab: some View {
        VStack(alignment: .leading, spacing: 14) {
            Text("Use AI to expand bullet points and notes into ready-to-read teleprompter scripts.")
                .font(.system(size: 11))
                .foregroundStyle(.secondary)
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                HStack(spacing: 8) {
                    if aiKeyVisible {
                        TextField("sk-ant-...", text: $settings.aiApiKey)
                            .textFieldStyle(.roundedBorder)
                            .font(.system(size: 12, design: .monospaced))
                    } else {
                        SecureField("sk-ant-...", text: $settings.aiApiKey)
                            .textFieldStyle(.roundedBorder)
                            .font(.system(size: 12, design: .monospaced))
                    }
            ...
            if !settings.aiApiKey.isEmpty {
                ...
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    Text("Use the **AI Expand** button in the toolbar to transform your notes into a script.")
                        .font(.system(size: 11))
                        .foregroundStyle(.secondary)
                }
            }
