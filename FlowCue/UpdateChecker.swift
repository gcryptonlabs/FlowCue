...
class UpdateChecker {
    ...
    private let repoOwner = "gcryptonlabs"
    private let repoName = "FlowCue"
    ...
    private func showUpdateAvailable(latestVersion: String, releaseURL: String) {
        ...
        alert.informativeText = "FlowCue \(latestVersion) is available. You are currently running \(currentVersion)."
    ...
    private func showUpToDate() {
        ...
        alert.informativeText = "FlowCue \(currentVersion) is the latest version."
        alert.alertStyle = .informational
