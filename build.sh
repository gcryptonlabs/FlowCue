...
ARCHIVE_ARM="$BUILD_DIR/FlowCue-arm64.xcarchive"
ARCHIVE_X86="$BUILD_DIR/FlowCue-x86_64.xcarchive"
APP_NAME="FlowCue.app"
OUTPUT_DIR="$BUILD_DIR/universal"
OUTPUT_APP="$OUTPUT_DIR/$APP_NAME"
DMG_NAME="FlowCue.dmg"
...
xcodebuild archive \
  -project "$PROJECT_DIR/FlowCue.xcodeproj" \
  -scheme "$SCHEME" \
...
echo "   DMG:  $DMG_PATH"
echo ""
lipo -info "$OUTPUT_APP/Contents/MacOS/FlowCue"
